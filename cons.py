...
<ui>
    <menubar name='MenuBar'>
        ...
        <menu action='ImportMenu'>
            ...
            <menuitem action='FromHtml'/>
            <menuitem action='FromHtmlToc'/>
        </menu>
...
def get_entries(inst):
    ...
    ( "FromHtml", STR_STOCK_CT_IMP, _("From _Html file"), None, _("Add Nodes of a Html File to the Current Tree"), inst.nodes_add_from_html_file),
    ( "FromHtmlToc", STR_STOCK_CT_IMP, _("From _HtmlToc file"), None, _("Add Nodes of a Html Toc File to the Current Tree"), inst.nodes_add_from_html_toc),
...
def get_popup_menu_tree(inst):
    ...
    (STR_STOCK_CT_IMP, _("From _Html file"), None, _("Add Nodes of a Html file to the Current Tree"), inst.nodes_add_from_html_file),
    ("submenu-end", None, None, None, None),
